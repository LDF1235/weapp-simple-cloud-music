...
export const ROUTE_FEATURED_PLAYLIST = "/pages/featuredPlaylist/index";
export const ROUTE_OFFICIAL_PLAYLIST = "/pages/officialPlaylist/index";
export const ROUTE_HIGH_QUALITY_PLAYLIST = "/pages/highQualityPlaylist/index";
export const ROUTE_DAILY_RECOMMEND = "/pages/dailyRecommend/index";
export const ROUTE_LIKE_PLAYLIST = "/pages/likePlaylist/index";
